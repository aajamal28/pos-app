    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Master Data Bank</h3>
                    ...
                    <div class="modal-body">
                        <form class="form-horizontal">
                            ...
                            <div class="form-group row">
                                <label for="rlg_id" class="col-sm-2 control-label text-info">ID Bank</label>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="rlg_id" placeholder="Input Kode Bank">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="rlg_desc" class="col-sm-2 control-label text-info">Deskripsi </label>
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" id="rlg_desc" placeholder="Nama Bank">
                                </div>
                            </div>
                        </form>
                    </div>
